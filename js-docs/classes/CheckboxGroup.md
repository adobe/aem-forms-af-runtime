...
- [constraintMessage](CheckboxGroup.md#constraintmessage)
...
- [\_onlyViewNotify](CheckboxGroup.md#_onlyviewnotify)
...
- [getPropertiesManager](CheckboxGroup.md#getpropertiesmanager)
